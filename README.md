...
| Этап | Описание |
|------|----------|
| **[Предобработка](#предобработка)** | Очистка, фильтрация, агрегация сессий |
| **[Гипотеза 1: Цена](#гипотеза-1-цена)** | Влияние цены товара на конверсию |
| **[Гипотеза 2: Просмотры](#гипотеза-2-просмотры)** | Глубина просмотра и вероятность покупки |
| **[Гипотеза 3: День недели](#гипотеза-3-день-недели)** | Разница конверсии будни/выходные |
| **[Гипотеза 4: Время суток](#гипотеза-4-время-суток)** | Взаимосвязь времени и типа дня |
| **[Гипотеза 5: Просмотры по дням](#гипотеза-5-просмотры-по-дням)** | Различия в поведении по дням недели |
| **[Гипотеза 6: Категории](#гипотеза-6-категории)** | Влияние категории товара на покупку |
| **[Модель прогнозирования](#модель-прогнозирования)** | Логистическая регрессия: прогноз и интерпретация |
...
| Этап | Описание |
|------|----------|
| **[Предобработка](#предобработка-очистка-фильтрация-агрегация-сессий)** | Очистка, фильтрация, агрегация сессий |
...
| **[Модель прогнозирования](#модель-прогнозирования-логистическая-регрессия)** | Логистическая регрессия: прогноз и интерпретация |
